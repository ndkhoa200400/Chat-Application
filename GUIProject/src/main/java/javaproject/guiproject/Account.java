...
public class Account {
    ...
    static boolean isExisted(String username) {
        ...
        try (FileReader reader = new FileReader("E:\\Code\\Code Java\\GUIProject\\src\\main\\java\\javaproject\\guiproject\\accounts.json")) {
            // Read JSON file
    ...
    static boolean checkAccount(String username, String password) throws IOException {
        ...
        try {
            ...
            reader = new BufferedReader(new FileReader("E:\\Code\\Code Java\\GUIProject\\src\\main\\java\\javaproject\\guiproject\\accounts.json"));
            JsonArray obj = (JsonArray) gson.fromJson(reader, JsonArray.class);
    ...
    static void signUp(String username, String password) throws IOException {
        ...
        try{
            ...
            try (FileReader reader = new FileReader("E:\\Code\\Code Java\\GUIProject\\src\\main\\java\\javaproject\\guiproject\\accounts.json")) {
                ...
                obj.add(temp);
                writer = new FileWriter("E:\\Code\\Code Java\\GUIProject\\src\\main\\java\\javaproject\\guiproject\\accounts.json", false);
